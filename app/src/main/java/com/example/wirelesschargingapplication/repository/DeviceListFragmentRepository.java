//WID(03/06/2026)(DegamieSign)(Sarthak Mittal)#1.1.1.1.1.1.1.1C.1c.1.1.1.1.1c.1s.1.1.1.1    
...
public interface DeviceListRepsitory extends JpaRepository<DeviceListFragment,String> {  //Fetching and Retrieving All DeviceListFragment's Params
    public void existsByDeviceListFragment(DeviceListFragment devicelistfragment);
    public void updateByDevicelistfragment(DeviceListFragment devicelistfragment);
    public void setDevicelistfragment(DeviceListFragment devicelistfragment){this.devicelistfragment=devicelistfragment;}//Bidning DeviceList Fragment in App
    public List<DeviceListFragment>existsByDeviceListFragment(DeviceListFragment devicelistfragments);
...
//    public
    ...
    public List<DeviceListFragment> savebyDevicelIstFragment(DeviceListFragment devicelistfragments);
    ...
    public void existsByPortNum(String port);
