//WID(09/05/2026)(Sarthak Mittal)(DegamieSign)#1.1.1.1
...
public interface DeviceListRepsitory extends JpaRepository<DeviceListFragment,String> {
    public List<DeviceListFragment> existsByfragementId(String fragmentId);

    public List<DeviceListFragment> updateByfragementId(String fragmentId);
