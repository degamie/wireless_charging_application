...
public class MainBatteryManagement extends AppCompatActivity {
    ...
    public ImageView iv_View =(ImageView)findViewById(R.id.iv_View);
    public TextView tv_View =(TextView)findViewById(R.id.tv_View);
    ...
    public void onCreate(Bundle savedInstanceState) {
        Runnable  runnable= new Runnable() {
            ...
            public void run(){
                ...
                if(batteryLevel>75){
                    iv_View.setImageResource(R.drawable.batteryLevel*100)
                }
...
//        super.onCreate()
        ...
        BatteryManager battery=(TextView)findViewById(R.layout.id.battery);
        this.registerReciever(this.BatteryManager,new IntentFilter(Intent.ACTION_BATTERY_CHANGED));
